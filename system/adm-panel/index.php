...
$menu5 = "clients";
$menu6 = "sales";
$menu7 = "type-of-shipping";
$menu8 = "characteristic";
$menu9 = "alerts";
$menu10 = "coupons";
$menu11 = "stock";
$menu12 = "blog";
...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="Geisa Amaral">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Products</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Categories</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Subcategories</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu7 ?>">Types of Shipping</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu8 ?>">Characteristic</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                        ...
                        <span>Combos and Promotions</span>
                    </a>
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                        
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu14 ?>">Combos</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Promotions</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu9 ?>">Alerts</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu13 ?>">Home Banner</a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="img-profile rounded-circle" src="../../images/man-boné.jpg">
